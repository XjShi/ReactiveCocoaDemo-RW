...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  cell.twitterUsernameText.text = [NSString stringWithFormat:@"@%@",tweet.username];
    ...
    [[[self signalForLoadingImage1:tweet.profileImageUrl]
...
- (RACSignal *)signalForLoadingImage1:(NSString *)imageUrl {
    RACScheduler *schedular = [RACScheduler schedulerWithPriority:RACSchedulerPriorityBackground];
